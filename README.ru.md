...
проблемными сотрудниками) находится в [docs/admin-guide.ru.md](docs/admin-guide.ru.md). Список изменений
по версиям - в [CHANGELOG.ru.md](CHANGELOG.ru.md), как обновиться на новую версию не потеряв базу - в
[docs/upgrading.ru.md](docs/upgrading.ru.md).
